...
def mobility_ingestion():
    ...
    # ===========================================================
    # 3. CAPA BRONZE (CARGA BATCH 365 DÍAS)
    # ===========================================================
    ...
    batch_overrides_list = [
        {
            "environment": [
                {
                    "name": "SQL_QUERY", 
                    "value": f"{sql_prefix} INSERT INTO lake.bronze.trips_municipios_2023 SELECT * FROM read_csv('{fp}', header=true, auto_detect=true, all_varchar=true);"
                },
